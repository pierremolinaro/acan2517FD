...
//······················································································································
    ...
    private:
        ...
        public:
            Filter *mNextFilter;
        public:
            const uint32_t mFilterMask;
        public:
            const uint32_t mAcceptanceFilter;
        public:
            const ACANFDCallBackRoutine mCallBackRoutine;

        public:
            Filter(const uint32_t inFilterMask,
...
//······················································································································
    ...
    public:
        void appendPassAllFilter(const ACANFDCallBackRoutine inCallBackRoutine) {  // Accept any frame
...
//······················································································································
    ...
    public:
        void appendFormatFilter(const tFrameFormat inFormat, // Accept any identifier
                                const ACANFDCallBackRoutine inCallBackRoutine) {
...
//······················································································································
    ...
    public:
        void appendFrameFilter(const tFrameFormat inFormat,
...
//······················································································································
    ...
    public:
        void appendFilter(const tFrameFormat inFormat,
...
//······················································································································
    ...
    public:
        FilterStatus filterStatus(void) const { return mFilterStatus; }

    public:
        uint8_t filterErrorIndex(void) const { return mFilterErrorIndex; }

    public:
        uint8_t filterCount(void) const { return mFilterCount; }
...
//······················································································································
    ...
    private:
        uint8_t mFilterCount = 0;
    private:
        Filter *mFirstFilter = NULL;
    private:
        Filter *mLastFilter = NULL;
    private:
        FilterStatus mFilterStatus = kFiltersOk;
    private:
        uint8_t mFilterErrorIndex = 0;
...
//······················································································································
    ...
    private:
        ACAN2517FDFilters(const ACAN2517FDFilters &) = delete;

    private:
        ACAN2517FDFilters &operator=(const ACAN2517FDFilters &) = delete;
