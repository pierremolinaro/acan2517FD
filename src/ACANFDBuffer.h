...
//······················································································································
    ...
    private:
        uint32_t mCount;
    private:
        uint32_t mPeakCount; // > mSize if overflow did occur
...
//······················································································································
    ...
    public:
        inline bool isFull(void) const { return mCount == mSize; } // Added in release 2.17 (thanks to Flole998)
    public:
        inline uint32_t peakCount(void) const { return mPeakCount; }
...
//······················································································································
    ...
    public:
        void initWithSize(const uint32_t inSize) {
            delete[] mBuffer;
...
//······················································································································
    ...
    public:
        bool append(const CANFDMessage &inMessage) {
...
//······················································································································
    ...
    public:
        bool remove(CANFDMessage &outMessage) {
...
//······················································································································
    ...
    private:
        ACANFDBuffer(const ACANFDBuffer &) = delete;

    private:
        ACANFDBuffer &operator=(const ACANFDBuffer &) = delete;
    };
